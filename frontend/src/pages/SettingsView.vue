...
- duration 优先 6-10 秒；低运动、情绪停顿或对话反应可 10-15 秒；过渡镜头可 3-6 秒，duration 不是剧情容量指标
...
- 自检时确认：每个镜头都有 director_intent；audience_info_change 和 dramatic_value 能证明镜头不可删除；title 不得为“镜头X”；shot_number 唯一递增；关键揭示没有被过度压缩，上一镜最后一帧和下一镜第一帧能直接剪，必要时新增 1 个 3-6 秒过渡镜头，前后镜头没有物理矛盾，台词/旁白没有漏进 dialogue`,
