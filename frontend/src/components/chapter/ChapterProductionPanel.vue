  ...
  <div class="content-panel">
    ...
    <template v-else>
      ...
      <ProductionCharacterGallery
        ...
        :manual-busy="state.manualAssetBusy"
        @manual-add="handlers.handleManualCharacterAdd"
        ...
        @clear-character-reference="handlers.handleCharacterReferenceClear"
      ...
      <ProductionSceneGallery
        ...
        :manual-busy="state.manualAssetBusy"
        @manual-add="handlers.handleManualSceneAdd"
