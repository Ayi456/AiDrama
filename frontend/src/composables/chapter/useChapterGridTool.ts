...
export function useChapterGridTool(options: UseChapterGridToolOptions) {
  ...
  const gridStorageKey = computed(() => `aidrama:grid:${options.dramaId}:${options.epId.value || options.chapterNumber}`)
