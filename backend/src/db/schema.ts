...
export const storyboards = mysqlTable('storyboards', {
  ...
  action: text('action'),
  result: text('result'),
  directorIntent: text('director_intent'),
  audienceInfoChange: text('audience_info_change'),
  emotionShift: text('emotion_shift'),
  dramaticValue: text('dramatic_value'),
  ...
  audioBridge: text('audio_bridge'),
  negativePrompt: text('negative_prompt'),
  fallbackPlan: text('fallback_plan'),
  handleInMs: int('handle_in_ms').default(500),
  handleOutMs: int('handle_out_ms').default(500),
