...
function buildStoryboardUpdateBindingSource(
  ...
  return {
    ...
    director_intent: 'director_intent' in body ? body.director_intent : storyboard.directorIntent,
    audience_info_change: 'audience_info_change' in body ? body.audience_info_change : storyboard.audienceInfoChange,
    emotion_shift: 'emotion_shift' in body ? body.emotion_shift : storyboard.emotionShift,
    dramatic_value: 'dramatic_value' in body ? body.dramatic_value : storyboard.dramaticValue,
